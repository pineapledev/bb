...
namespace nit
{
    ...
    const GamepadKeys keyboard_keys[g_num_keyboard_keys] =
    {
        GamepadKeys::KeySpace,
        GamepadKeys::KeyApostrophe,
        GamepadKeys::KeyComma,
        GamepadKeys::KeyMinus,
        GamepadKeys::KeyPeriod,
        GamepadKeys::KeySlash,
        GamepadKeys::Key0,
        GamepadKeys::Key1,
        GamepadKeys::Key2,
        GamepadKeys::Key3,
        ...
        GamepadKeys::Key8,
        GamepadKeys::Key9,
        GamepadKeys::KeySemicolon,
        GamepadKeys::KeyEqual,
        GamepadKeys::KeyA,
        GamepadKeys::KeyB,
        GamepadKeys::KeyC,
        GamepadKeys::KeyD,
        ...
        GamepadKeys::KeyY,
        GamepadKeys::KeyZ,
        GamepadKeys::KeyLeftBracket,
        GamepadKeys::KeyBackSlash,
        GamepadKeys::KeyRightBracket,
        GamepadKeys::KeyGraveAccent,
        GamepadKeys::KeyWorld1,
        GamepadKeys::KeyWorld2,
        GamepadKeys::KeyEscape,
        GamepadKeys::KeyEnter,
        GamepadKeys::KeyTab,
        GamepadKeys::KeyBackSpace,
        GamepadKeys::KeyInsert,
        GamepadKeys::KeyDelete,
        GamepadKeys::KeyRight,
        GamepadKeys::KeyLeft,
        GamepadKeys::KeyDown,
        GamepadKeys::KeyUp,
        GamepadKeys::KeyPageUp,
        GamepadKeys::KeyPageDown,
        GamepadKeys::KeyHome,
        GamepadKeys::KeyEnd,
        GamepadKeys::KeyCapsLock,
        GamepadKeys::KeyScrollLock,
        GamepadKeys::KeyNumLock,
        GamepadKeys::KeyPrintScreen,
        GamepadKeys::KeyPause,
        GamepadKeys::KeyF1,
        GamepadKeys::KeyF2,
        GamepadKeys::KeyF3,
        GamepadKeys::KeyF4,
        ...
        GamepadKeys::KeyKp8,
        GamepadKeys::KeyKp9,
        GamepadKeys::KeyKpDecimal,
        GamepadKeys::KeyKpDivide,
        GamepadKeys::KeyKpMultiply,
        GamepadKeys::KeyKpSubstract,
        GamepadKeys::KeyKpAdd,
        GamepadKeys::KeyKpEnter,
        GamepadKeys::KeyKpEqual,
        GamepadKeys::KeyLeftShift,
        GamepadKeys::KeyLeftControl,
        GamepadKeys::KeyLeftAlt,
        GamepadKeys::KeyLeftSuper,
        GamepadKeys::KeyRightShift,
        GamepadKeys::KeyRightControl,
        GamepadKeys::KeyRightAlt,
        GamepadKeys::KeyRightSuper,
        GamepadKeys::KeyMenu
    };

    const u32 keyboard_key_codes[g_num_keyboard_keys] =
    {
        KeySpace,
        KeyApostrophe,
        KeyComma,
    ...
    const GamepadKeys glfw_button_keys[g_num_xbox_buttons] =
    {
        GamepadKeys::GamepadButtonSouth,
        GamepadKeys::GamepadButtonEast,
        GamepadKeys::GamepadButtonWest,
        GamepadKeys::GamepadButtonNorth,
        GamepadKeys::GamepadButtonLeftBumper,
        GamepadKeys::GamepadButtonRightBumper,
        GamepadKeys::GamepadButtonSelect,
        GamepadKeys::GamepadButtonStart,
        GamepadKeys::GamepadButtonLeftThumb,
        GamepadKeys::GamepadButtonRightThumb,
        GamepadKeys::GamepadButtonDpadUp,
        GamepadKeys::GamepadButtonDpadRight,
        GamepadKeys::GamepadButtonDpadDown,
        GamepadKeys::GamepadButtonDpadLeft,
    };

    const GamepadKeys glfw_axis_keys[g_num_xbox_axis] =
    {
        GamepadKeys::GamepadAxisLeftX,
        GamepadKeys::GamepadAxisLeftY,
        GamepadKeys::GamepadAxisRightX,
        GamepadKeys::GamepadAxisRightY,
        GamepadKeys::GamepadAxisLeftTrigger,
        GamepadKeys::GamepadAxisRightTrigger,
    };
}